...
package Course2.Week1.Part2_BreakingCaesarCipher;
import edu.duke.*;

public class CommonWords
{
    public static String[] getCommon(){
		FileResource resource = new FileResource("ReferenceData/Course2Week1CesarCypher/CommonWordsData/common.txt");
