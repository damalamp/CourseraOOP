...
public class StoringAllGenes
{
	...
	public static int findStopIndex(String dna, int index){
        ...
        System.out.println("found a tga at: " + stop1);
	...
	public static void printGenes(StorageResource sr){
        ...
        for (String gene : sr.data()) {
			...
			System.out.println("genezzz = " + gene);
	...
	//DirectoryResource dr = new DirectoryResource();
        ...
        //for (File f : dr.selectedFiles()) {
            ...
            //dnaStore = storeAll(s); 
            StorageResource dnaStore = storeAll("atg1tga2tga3tga");
            System.out.println("look ma, i'm running");
            printGenes(dnaStore);
            FindCTG(dnaStore);
        //}
	}
